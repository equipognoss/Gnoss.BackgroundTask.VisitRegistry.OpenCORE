...
RUN groupadd -g 2000 gnoss && useradd -u 2000 -g 2000 gnoss &&\
	mkdir -p logs trazas Visitas recursos Votos Comentarios &&\
	chown -R gnoss:gnoss logs trazas Visitas recursos Votos Comentarios &&\
	chmod -R 777 logs trazas Visitas recursos Votos Comentarios
USER gnoss
